...
UPDATE shows SET title = "It’s Always Sunny in Philadelphia" WHERE title LIKE "It%Always Sunny in Philadelphia";
...
UPDATE shows SET title = "The Queen’s Gambit" WHERE title LIKE "The Queen%Gambit";
